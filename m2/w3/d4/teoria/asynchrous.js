...
const countUntilThree = function () {
  ...
  const start = function () {
    countUntilThree()
    console.log('fatto!')
    // ma se voi alla riga 11 avete bisogno del risultato della riga 10 per andare avanti,
    // come fate? la riga 11 verrà eseguita indipendentemente dalla riga 10, immediatamente
    //   dopo!
  }
